...
import { useParams } from "next/navigation"; // Import useParams for proper type handling
...
const Page = (): JSX.Element => {
  ...
  const productId = params?.id as string; // Ensure it is treated as a string
  ...
  useEffect(() => {
    if (!productId) return; // Ensure we have a valid ID
